...
def can_find_using_where_clause_and_be_sorted
  ...
  # "SELECT * WHERE release_date > 2002"
# binding.pry
  x = Movie.all.map do |m|
...
def can_be_found_updated_and_saved
  ...
  thing = Movie.find_by(title: "Awesome Flick")
  thing.update(title: "Even Awesomer Flick")
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  Movie.create(title: "Wat?")
  thing = Movie.find_by(title: "Wat?")
  thing.update(title: "Wat, huh?")
end
...
def can_update_multiple_items_at_once
  ...
  Movie.all.each {|f| f.update(title: "A Movie")}
end
